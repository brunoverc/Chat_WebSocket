    ...
    var constructor = function (url) {
        ...
        if (res[1] === undefined) {
            ...
            if (parm[0] != 'user') {
                ...
                $("#fieldUser").val("Usuário: @" + userName);
            }
        }
        ...
        var Message = function (messageType, data) {
            this.$type = 'CWS.Domain.Shared.Message';
        ...
        var InvocationDescriptor = function (methodName, args, identifier) {
            this.$type = 'CWS.Domain.Shared.Networking.InvocationDescriptor';
        ...
        var InvocationResult = function (identifier, result, exception) {
            this.$type = 'CWS.Domain.Shared.Networking.InvocationResult';
            this.result = result;
            ...
            if (exception !== undefined) {
                this.exception = {
                    $type: "CWS.Domain.Shared.Networking.RemoteException",
                    message: exception
                }
            }
        };
